...
exports.assertion = function(selector, expectedText, msg) {
  ...
  var MSG_ELEMENT_NOT_FOUND = 'Testing if element <%s> does not contains text: "%s". ' +
    'Element could not be located.';

  this.message = msg || util.format('Testing if element <%s> does not contains text: "%s".', selector, expectedText);

  this.expected = function() {
    return 'Not To find ' + expectedText;
  };
